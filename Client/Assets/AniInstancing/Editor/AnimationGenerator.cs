    ...
    public class AnimationGenerator : EditorWindow
    {
        ...
        void BakeWithAnimator()
        {
            if (generatedPrefab != null)
            {
                ...
                AnimationInstancing script = generatedObject.GetComponentInChildren<AnimationInstancing>();
                Debug.Assert(script);
        ...
        void AnalyzeStateMachine(UnityEditor.Animations.AnimatorStateMachine stateMachine,
            ...
            int animationIndex)
        {
            AnimationInstancing instance = generatedPrefab.GetComponentInChildren<AnimationInstancing>();
            if (instance == null)
            {
