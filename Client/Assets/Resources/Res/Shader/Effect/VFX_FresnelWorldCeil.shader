Shader "XSJ/VFX/FxFresnelWorldCeil"
{
    Properties
    {
        ...
        [Header(Ohter)]
        _WorldClip("WorldClip",Range(0,1)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float worldposHigh = normalize(i.worldPos).y;
                ...
                col.rgb += rim;
                col.rgb *= i.color.rgb;
                col.a = _AlphaValue * i.color.a*ceil(worldposHigh);
                return col;
            }
            ENDCG
        }
