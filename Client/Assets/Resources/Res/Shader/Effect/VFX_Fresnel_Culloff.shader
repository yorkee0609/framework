Shader "XSJBeijing/VFX/FxFresnelCulloff"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform half _RimPower,_UseUV2;
            ...
            struct v2f {
                ...
                float2 uv : TEXCOORD4;
                float4 TW0:TEXCOORD5;
                float4 TW1:TEXCOORD6;
                float4 TW2:TEXCOORD7;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float2 blendUV = lerp(i.uv1,i.uv0,_UseUV2) ;
                fixed4 maincolor = tex2D(_MainTex, blendUV.xy);
