...
namespace Xxtea {
    ...
    public sealed class XXTEA {
        ...
        public static Byte[] DecryptBase64String(String data, Byte[] key) {
            byte[] b_content = Convert.FromBase64String(data);
            if (b_content != null)
            {
                return Decrypt(b_content, key);
            }
            return null;
        }
        ...
        public static String DecryptToString(Byte[] data, Byte[] key) {
            byte[] b_content = Decrypt(data, key);
            if (b_content != null)
            {
                return utf8.GetString(b_content);
            }
            return null;
        }
        ...
        public static String DecryptBase64StringToString(String data, Byte[] key) {
            byte[] b_content = DecryptBase64String(data, key);
            if (b_content != null)
            {
                return utf8.GetString(b_content);
            }
