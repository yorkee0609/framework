...
namespace wc.framework
{
    ...
    public unsafe class LuaArrAccess
    {
        ...
        public virtual int GetIntFast(int index)
        {
            return 0;
        }
        ...
        public virtual double GetDoubleFast(int index)
        {
            return 0;
        }
    ...
    public unsafe class LuaArrAccess32 : LuaArrAccess
    {
        ...
        public override int GetIntFast(int index)
        {
            if (TableRawPtr != null)
            {
                index = index - 1;
        ...
        public override double GetDoubleFast(int index)
        {
            if (TableRawPtr != null)
            {
                index = index - 1;
