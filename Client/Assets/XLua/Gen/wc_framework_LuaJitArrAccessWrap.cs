...
namespace XLua.CSObjectWrap
{
    ...
    public class wcframeworkLuaJitArrAccessWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(wc.framework.LuaJitArrAccess);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new wc.framework.LuaJitArrAccess();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to wc.framework.LuaJitArrAccess constructor!");
        ...
        static int _m_ToString(RealStatePtr L)
        {
		    try {
                ...
                wc.framework.LuaJitArrAccess gen_to_be_invoked = (wc.framework.LuaJitArrAccess)translator.FastGetCSObj(L, 1);
